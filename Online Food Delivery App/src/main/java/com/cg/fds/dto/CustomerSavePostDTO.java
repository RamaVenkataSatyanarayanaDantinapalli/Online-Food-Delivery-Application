...
public class CustomerSavePostDTO {
	...
	public CustomerSavePostDTO(@NotNull(message = "customerId is empty") int customerid,@NotNull(message = "first name is empty")
String firstName,String lastName,String gender, int age, @NotNull(message = "Mobile number is empty")
