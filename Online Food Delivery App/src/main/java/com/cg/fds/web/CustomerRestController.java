...
public class CustomerRestController {
	...
	public ResponseEntity<CustomerBasicInfoDTO> addCustomer(@RequestBody @Valid CustomerSavePostDTO c)//,HttpServletRequest request) throws InvalidLoginException
	{
